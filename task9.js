...
function infoButton(){
	alert('Данный калькулятор может работать с неограниченным кол-вом операций. Операции будут выполняться в порядке их внесения в калькулятор. Пожалуйста не вводите слишком большие числа');
}
function fullStrButton(){
	alert('Счетная строка: ' + grayNumb + blackNumb);
}